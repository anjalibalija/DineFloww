                ...
                <form className="px-8 pb-8 pt-6 space-y-4 text-left" onSubmit={handleSubmit} autoComplete="off">
                  ...
                  <AnimatePresence>
                    {!isLogin && (
                      ...
                      >
                        <label htmlFor="user-auth-name" className="block text-sm font-semibold text-brown-700/60 uppercase tracking-widest mb-2">
                          Full Name
                        </label>
                  ...
                  <div>
                    <label htmlFor="user-auth-email" className="block text-sm font-semibold text-brown-700/60 uppercase tracking-widest mb-2">
                  ...
                  {/* Password */}
                  <div>
                    <label htmlFor="user-auth-password" className="block text-sm font-semibold text-brown-700/60 uppercase tracking-widest mb-2">
                      Password
                    </label>
                    <div className="relative">

...
const EditRestaurantForm = ({ restaurant, onClose, onSuccess, isDemoMode = false }) => {
  ...
  const parseInitialState = () => {
    ...
    let initSettings = restaurant.reservationSettings || defaultSettings;
    ...
    let initSocials = restaurant.socialLinks || defaultSocials;
    ...
    let initVerification = restaurant.verification || defaultVerification;
    ...
    return {
      ...
      reservationSettings: initSettings,
      socialLinks: initSocials,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`/api/restaurants/${restaurant.id}`, finalForm);
      onSuccess();
    } catch (err) {
                  ...
                  <div className="bg-gold-50/40 border border-gold-500/15 p-4 rounded-xl space-y-2 mt-4">
                    ...
                    <div className="flex flex-wrap items-center gap-2.5">
                      ...
                      {menuImage && (
                        ...
                        >
                          {digitizing ? (
                            <div className="w-3 h-3 border-2 border-cream-100/30 border-t-cream-100 rounded-full animate-spin" />
                          ) : (
                            <Sparkles size={12} />
                          )}
